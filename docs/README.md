...
This directory is the canonical documentation entry point for Backyard Racer. The Infiltrator project family uses the same baseline document roles in every repository so readers can move between projects without relearning the structure.
...
- docs/RENDERING_AND_PRESENTATION.md — specialist or historical detail retained alongside the canonical baseline.
- docs/VEHICLE_PRESENTATION_AND_PAINT.md — specialist or historical detail retained alongside the canonical baseline.
- docs/UPSTREAM.md — specialist or historical detail retained alongside the canonical baseline.
